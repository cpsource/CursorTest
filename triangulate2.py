...
Return ONLY the distance in tenths of miles as a decimal number (e.g., 0.8, 1.2, 2.5). Do not include units or explanations."""
    ...
    def triangulate_location(self, facilities, reference_location):
        ...
        try:
            ...
            full_prompt = f"""You are a geographic analyst specializing in San Francisco. Given a list of known facilities and their distances from an unknown location, determine the most likely location that satisfies all these distance constraints.
